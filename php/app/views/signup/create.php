<section class="fullscreen ph_separator">
    <div class="ph_separator_half">
        <div class="ph_text">
            ...
            <h2 class="ph_mobile_hide">Erstellen</h2>
            ...
            <form action="" method="POST">
                ...
                <label class="check" ><input autofocus="autofocus" type="checkbox" name="ph_signup_cond" required /> Ich akzeptiere die <a target="_blank" href="/conditions/">Nutzungsbedingungen</a></label>
